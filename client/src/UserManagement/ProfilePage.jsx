...
export default function ProfilePage() {
  ...
  return (
    <div dir={direction} className="min-h-screen bg-slate-100 flex flex-col">
      <PageHeader title={t("profilePage")} buttonText={t("homeButton")} to="/home" />
        ...
        <div className="max-w-[1150px] mx-auto space-y-6">
          <section className="grid grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl shadow-xl p-6">
              ...
              <p>
                ...
                {loading ? t("loading") : student?.role || t("studentFallback")}
              </p>
              ...
              <p>
                <strong>{t("stdYear")}:</strong> {student?.year || t("yearFallback")}
              </p>
            </div>
          ...
          <section className="bg-white rounded-2xl shadow-xl p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              >
                <option value="name">{t("courseName")}</option>
                <option value="grade">{t("courseGrade")}</option>
              </select>
            </div>
